...
ori_signal = np.load("train_orisignal.npy")
...
for epoch_idx in range(Epoch):
    ...
    for batch_idx, data in enumerate(tr_data_loader):
        ...
        tr_optimizer.step()
        cur_MSE += loss_val
    learning_curve[epoch_idx] = cur_MSE/batch_size
...
torch.save(MemAE,'trained_model_sequence.pth')
